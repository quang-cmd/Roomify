...
public class RoomSearchDialog extends JDialog {
    ...
    private JPanel createHeader() {
        ...
        JLabel title = new JLabel("Tìm phòng");
    ...
    private JPanel createFieldsRow() {
        ...
        cbStatus = new JComboBox<>(new String[]{"Tất cả loại phòng", "Trống", "Đang sử dụng", "Bảo trì"});

        panel.add(createFieldCol("Mã phòng", txtRoomId));
        panel.add(createFieldCol("Loại phòng", cbRoomType));
        panel.add(createFieldCol("Trạng thái", cbStatus));
