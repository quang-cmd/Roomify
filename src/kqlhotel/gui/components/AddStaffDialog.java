...
public class AddStaffDialog extends JDialog {
    ...
    private JPanel buildForm() {
        ...
        cbTinhTrang = styledCombo(new String[]{"Đang hoạt động", "Nghỉ phép", "Nghỉ việc"});
    ...
    private void onConfirm() {
        ...
        switch (statusDisplay) {
            case "Nghỉ phép": status = "NghiPhep";     break;
            case "Nghỉ việc": status = "NghiViec";     break;
            default:          status = "DangHoatDong"; break;
        }
